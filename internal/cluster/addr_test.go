...
func TestParseNodeAddr(t *testing.T) {
	for i, test := range parseNodeAddrTests {
		addr, err := ParseNodeAddr(test.Addr)
...
func TestNodeAddr_IsLoopback(t *testing.T) {
...
var parseNodeAddrTests = []struct {
	...
	{Addr: "http://localhost:7373", Host: "localhost", Port: "7373"},                                // 1
	{Addr: "https://localhost:7373", Host: "localhost", Port: "7373"},                               // 2
	{Addr: "127.0.0.1:7373", Host: "127.0.0.1", Port: "7373"},                                       // 3
	{Addr: "localhost:443", Host: "localhost", Port: "443"},                                         // 4
	{Addr: "https://[fe80::21:a317:f548:eef1]:7000", Host: "fe80::21:a317:f548:eef1", Port: "7000"}, // 5
	{Addr: "[fe80::21:a317:f548:eef1]:7373", Host: "fe80::21:a317:f548:eef1", Port: "7373"},         // 6
	{Addr: "kes-0.local:7373", Host: "kes-0.local", Port: "7373"},                                   // 7

	{Addr: "127.0.0.1", ShouldFail: true},                    // 8
	{Addr: ":7373", ShouldFail: true},                        // 9
