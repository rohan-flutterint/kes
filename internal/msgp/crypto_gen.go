...
func (z *Secret) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	...
	for zb0001 > 0 {
		...
		case "1":
			z.N, err = dc.ReadUint32()
			if err != nil {
				err = msgp.WrapError(err, "N")
				return
			}
		case "2":
			z.Latest, err = dc.ReadUint32()
			if err != nil {
...
func (z *Secret) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 3
	// write "0"
	...
	err = en.WriteMapHeader(uint32(len(z.Versions)))
	if err != nil {
		err = msgp.WrapError(err, "Versions")
		return
	}
...
// DecodeMsg implements msgp.Decodable
func (z *SecretKey) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z *SecretKey) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 2
	// write "0"
...
// DecodeMsg implements msgp.Decodable
func (z *SecretKeyRing) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z *SecretKeyRing) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 3
	// write "0"
	err = en.Append(0x83, 0xa1, 0x30)
	if err != nil {
...
// DecodeMsg implements msgp.Decodable
func (z *SecretKeyVersion) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
	...
	for zb0001 > 0 {
		...
		case "0":
			...
			for zb0002 > 0 {
				...
				switch msgp.UnsafeString(field) {
				case "0":
					z.Key.Value, err = dc.ReadBytes(z.Key.Value)
					if err != nil {
						err = msgp.WrapError(err, "Key", "Value")
						return
					}
				case "1":
					z.Key.Cipher, err = dc.ReadUint()
					if err != nil {
...
// EncodeMsg implements msgp.Encodable
func (z *SecretKeyVersion) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 3
	// write "0"
	err = en.Append(0x83, 0xa1, 0x30)
	if err != nil {
...
// DecodeMsg implements msgp.Decodable
func (z *SecretVersion) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z *SecretVersion) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 4
	// write "0"
